...
Revision ID: b0f5becb9e7e
Revises: a5cffa318ac2
Create Date: 2024-10-17 04:14:57.133716
...
def upgrade():
    ...
    sa.Column('favorites', sa.Enum('personaje', 'vehiculo', 'planeta', name='favorite_type'), nullable=True),
